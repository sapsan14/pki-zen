...
// Base-path: defaults to "/" (subdomain deployment: zen.tyche.institute).
...
export default defineConfig({
  ...
  sitemap: {
    hostname: 'https://zen.tyche.institute',
  },
  markdown: {
  ...
  head: [
    ...
    ['meta', { property: 'og:image', content: `https://zen.tyche.institute/og.png?${ASSET_VERSION}` }],
    ['meta', { property: 'og:image:width', content: '1200' }],
    ['meta', { property: 'og:image:height', content: '630' }],
    ['meta', { property: 'og:url', content: 'https://zen.tyche.institute/' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:image', content: `https://zen.tyche.institute/og.png?${ASSET_VERSION}` }],
  ],
